...
python main.py --optimizer SGD --lr 1e-2 --n_bins 10 --epochs 250 --dataset CIFAR10 --model BBB         --mc_samples_eval 8 --mc_samples_test 64
python main.py --optimizer SGD --lr 1e-2 --n_bins 10 --epochs 250 --dataset CIFAR10 --model LLDropout   --mc_samples_eval 8 --mc_samples_test 64
python main.py --optimizer SGD --lr 1e-2 --n_bins 10 --epochs 250 --dataset CIFAR10 --model Dropout     --mc_samples_eval 8 --mc_samples_test 64
...
python main.py --optimizers StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 64 --gamma 1.0 --mc_samples 1
python main.py --optimizers StructuredNGD --structure arrowhead --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k   1,3,5 --mc_samples_val 8 --mc_samples_test 64 --gamma 1.0 --mc_samples 1

python main.py --optimizers StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 64 --gamma 0.1
python main.py --optimizers StructuredNGD --structure arrowhead --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k   1,3,5 --mc_samples_val 8 --mc_samples_test 64 --gamma 0.1

python main.py --optimizers StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 64 --gamma 0.0
python main.py --optimizers StructuredNGD --structure arrowhead --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k   1,3,5 --mc_samples_val 8 --mc_samples_test 64 --gamma 0.0

python main.py --optimizers StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 64 --mc_samples 3
python main.py --optimizers StructuredNGD --structure arrowhead --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k   1,3,5 --mc_samples_val 8 --mc_samples_test 64 --mc_samples 3

python main.py --optimizers StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 64 --mc_samples 5
python main.py --optimizers StructuredNGD --structure arrowhead --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k   1,3,5 --mc_samples_val 8 --mc_samples_test 64 --mc_samples 5
