...
python main.py --optimizer SGD --lr 1e-2 --n_bins 10 --epochs 250 --dataset CIFAR10 --model BBB         --mc_samples_val 8 --mc_samples_test 32
python main.py --optimizer SGD --lr 1e-2 --n_bins 10 --epochs 250 --dataset CIFAR10 --model LLDropout   --mc_samples_val 8 --mc_samples_test 32
python main.py --optimizer SGD --lr 1e-2 --n_bins 10 --epochs 250 --dataset CIFAR10 --model Dropout     --mc_samples_val 8 --mc_samples_test 32
...
python main.py --optimizer StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 32 --mc_samples 1 --gamma 1.0

python main.py --optimizer StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 32 --mc_samples 3 --gamma 1.0
...
#python main.py --optimizer StructuredNGD --structure arrowhead  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR10 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 32 --mc_samples 3 --gamma 1.0
