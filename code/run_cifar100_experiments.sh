...
python main.py --optimizer StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR100 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 64 --gamma 1.0 --mc_samples 1
...
python main.py --optimizer StructuredNGD --structure arrowhead --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR100 --model ResNet32 --k   1,3,5 --mc_samples_val 8 --mc_samples_test 64 --gamma 0.0

python main.py --optimizer StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR100 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 64 --mc_samples 3
python main.py --optimizer StructuredNGD --structure arrowhead --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR100 --model ResNet32 --k   1,3,5 --mc_samples_val 8 --mc_samples_test 64 --mc_samples 3

python main.py --optimizer StructuredNGD --structure rank_cov  --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR100 --model ResNet32 --k 0,1,3,5 --mc_samples_val 8 --mc_samples_test 64 --mc_samples 5
python main.py --optimizer StructuredNGD --structure arrowhead --lr 1e-1 --n_bins 10 --epochs 250 --dataset CIFAR100 --model ResNet32 --k   1,3,5 --mc_samples_val 8 --mc_samples_test 64 --mc_samples 5
